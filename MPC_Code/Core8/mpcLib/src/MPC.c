...
alt_u8 totalCPUs = 8; // Make more general by determining fifoBaseAddresses-size.
...
// A list of all the FIFO variables, used in the MPC functions relating to the FIFO transactions.
alt_u32 fifoInCsrBaseAddresses [][8] = {
	{ 	
		0, 
		FIFO_0_TO_1_IN_CSR_BASE, 
		FIFO_0_TO_2_IN_CSR_BASE, 
		FIFO_0_TO_3_IN_CSR_BASE,
		FIFO_0_TO_4_IN_CSR_BASE,
		FIFO_0_TO_5_IN_CSR_BASE,
		FIFO_0_TO_6_IN_CSR_BASE,
		FIFO_0_TO_7_IN_CSR_BASE      
	},
	...
	{ 	
		...
		FIFO_1_TO_3_IN_CSR_BASE,
		FIFO_1_TO_4_IN_CSR_BASE,
		FIFO_1_TO_5_IN_CSR_BASE,
		FIFO_1_TO_6_IN_CSR_BASE,
		FIFO_1_TO_7_IN_CSR_BASE  
	},
	...
	{ 	
		...
		0, 
		FIFO_2_TO_3_IN_CSR_BASE,
		FIFO_2_TO_4_IN_CSR_BASE,
		FIFO_2_TO_5_IN_CSR_BASE,
		FIFO_2_TO_6_IN_CSR_BASE,
		FIFO_2_TO_7_IN_CSR_BASE   
	},

	{ 	FIFO_3_TO_0_IN_CSR_BASE, 
		FIFO_3_TO_1_IN_CSR_BASE, 
		FIFO_3_TO_2_IN_CSR_BASE, 
		0,
		FIFO_3_TO_4_IN_CSR_BASE,
		FIFO_3_TO_5_IN_CSR_BASE,
		FIFO_3_TO_6_IN_CSR_BASE, 
		FIFO_3_TO_7_IN_CSR_BASE 
	},

	{ 	FIFO_4_TO_0_IN_CSR_BASE, 
		FIFO_4_TO_1_IN_CSR_BASE, 
		FIFO_4_TO_2_IN_CSR_BASE, 
		FIFO_4_TO_3_IN_CSR_BASE,
		0,
		FIFO_4_TO_5_IN_CSR_BASE,
		FIFO_4_TO_6_IN_CSR_BASE,
		FIFO_4_TO_7_IN_CSR_BASE
	},

	{ 	FIFO_5_TO_0_IN_CSR_BASE, 
		FIFO_5_TO_1_IN_CSR_BASE, 
		FIFO_5_TO_2_IN_CSR_BASE, 
		FIFO_5_TO_3_IN_CSR_BASE,
		FIFO_5_TO_4_IN_CSR_BASE,
		0,
		FIFO_5_TO_6_IN_CSR_BASE,
		FIFO_5_TO_7_IN_CSR_BASE
	},

	{ 	FIFO_6_TO_0_IN_CSR_BASE, 
		FIFO_6_TO_1_IN_CSR_BASE, 
		FIFO_6_TO_2_IN_CSR_BASE, 
		FIFO_6_TO_3_IN_CSR_BASE,
		FIFO_6_TO_4_IN_CSR_BASE,
		FIFO_6_TO_5_IN_CSR_BASE,
		0,
		FIFO_6_TO_7_IN_CSR_BASE
	},

	{ 	FIFO_7_TO_0_IN_CSR_BASE, 
		FIFO_7_TO_1_IN_CSR_BASE, 
		FIFO_7_TO_2_IN_CSR_BASE, 
		FIFO_7_TO_3_IN_CSR_BASE,
		FIFO_7_TO_4_IN_CSR_BASE,
		FIFO_7_TO_5_IN_CSR_BASE,
		FIFO_7_TO_6_IN_CSR_BASE,
		0
	}
};
...
alt_u32 fifoOutCsrBaseAddresses [][8] = {
	{ 
		...
		FIFO_0_TO_3_OUT_CSR_BASE,
		FIFO_0_TO_4_OUT_CSR_BASE,
		FIFO_0_TO_5_OUT_CSR_BASE,
		FIFO_0_TO_6_OUT_CSR_BASE,
		FIFO_0_TO_7_OUT_CSR_BASE  
	},
	...
	{ 
		...
		FIFO_1_TO_3_OUT_CSR_BASE,
		FIFO_1_TO_4_OUT_CSR_BASE,
		FIFO_1_TO_5_OUT_CSR_BASE,
 		FIFO_1_TO_6_OUT_CSR_BASE,
 		FIFO_1_TO_7_OUT_CSR_BASE 
	},
	...
	{ 
		...
		0, 
		FIFO_2_TO_3_OUT_CSR_BASE,
		FIFO_2_TO_4_OUT_CSR_BASE,
		FIFO_2_TO_5_OUT_CSR_BASE,
		FIFO_2_TO_6_OUT_CSR_BASE,
		FIFO_2_TO_7_OUT_CSR_BASE 
	},

	{ 
		FIFO_3_TO_0_OUT_CSR_BASE, 
		FIFO_3_TO_1_OUT_CSR_BASE, 
		FIFO_3_TO_2_OUT_CSR_BASE, 
		0,
		FIFO_3_TO_4_OUT_CSR_BASE,
		FIFO_3_TO_5_OUT_CSR_BASE,
		FIFO_3_TO_6_OUT_CSR_BASE,
		FIFO_3_TO_7_OUT_CSR_BASE  
	},

	{ 
		FIFO_4_TO_0_OUT_CSR_BASE, 
		FIFO_4_TO_1_OUT_CSR_BASE, 
		FIFO_4_TO_2_OUT_CSR_BASE, 
		FIFO_4_TO_3_OUT_CSR_BASE,
		0,
		FIFO_4_TO_5_OUT_CSR_BASE,
		FIFO_4_TO_6_OUT_CSR_BASE,
		FIFO_4_TO_7_OUT_CSR_BASE
	},

	{ 
		FIFO_5_TO_0_OUT_CSR_BASE, 
		FIFO_5_TO_1_OUT_CSR_BASE, 
		FIFO_5_TO_2_OUT_CSR_BASE, 
		FIFO_5_TO_3_OUT_CSR_BASE,
		FIFO_5_TO_4_OUT_CSR_BASE,
		0,
		FIFO_5_TO_6_OUT_CSR_BASE,
		FIFO_5_TO_7_OUT_CSR_BASE
	},

	{ 
		FIFO_6_TO_0_OUT_CSR_BASE, 
		FIFO_6_TO_1_OUT_CSR_BASE, 
		FIFO_6_TO_2_OUT_CSR_BASE, 
		FIFO_6_TO_3_OUT_CSR_BASE,
		FIFO_6_TO_4_OUT_CSR_BASE,
		FIFO_6_TO_5_OUT_CSR_BASE,
		0,
		FIFO_6_TO_7_OUT_CSR_BASE
	},

	{ 
		FIFO_7_TO_0_OUT_CSR_BASE, 
		FIFO_7_TO_1_OUT_CSR_BASE, 
		FIFO_7_TO_2_OUT_CSR_BASE, 
		FIFO_7_TO_3_OUT_CSR_BASE,
		FIFO_7_TO_4_OUT_CSR_BASE,
		FIFO_7_TO_5_OUT_CSR_BASE,
		FIFO_7_TO_6_OUT_CSR_BASE,
		0
	}
};
...
alt_u32 fifoOutBaseAddresses [][8] = {
	{ 
		...
		FIFO_0_TO_3_OUT_BASE,
		FIFO_0_TO_4_OUT_BASE,
		FIFO_0_TO_5_OUT_BASE,
		FIFO_0_TO_6_OUT_BASE,
		FIFO_0_TO_7_OUT_BASE 
	},
	...
	{ 
		...
		FIFO_1_TO_3_OUT_BASE,
		FIFO_1_TO_4_OUT_BASE,
		FIFO_1_TO_5_OUT_BASE,
		FIFO_1_TO_6_OUT_BASE,
		FIFO_1_TO_7_OUT_BASE 
	},
	...
	{ 
		...
		0, 
		FIFO_2_TO_3_OUT_BASE,
		FIFO_2_TO_4_OUT_BASE,
		FIFO_2_TO_5_OUT_BASE,
		FIFO_2_TO_6_OUT_BASE,
		FIFO_2_TO_7_OUT_BASE 
	},

	{ 
		FIFO_3_TO_0_OUT_BASE, 
		FIFO_3_TO_1_OUT_BASE, 
		FIFO_3_TO_2_OUT_BASE, 
		0,
		FIFO_3_TO_4_OUT_BASE,
		FIFO_3_TO_5_OUT_BASE,
		FIFO_3_TO_6_OUT_BASE,
		FIFO_3_TO_7_OUT_BASE   
	},

	{ 
		FIFO_4_TO_0_OUT_BASE, 
		FIFO_4_TO_1_OUT_BASE, 
		FIFO_4_TO_2_OUT_BASE, 
		FIFO_4_TO_3_OUT_BASE,
		0,
		FIFO_4_TO_5_OUT_BASE,
		FIFO_4_TO_6_OUT_BASE,
		FIFO_4_TO_7_OUT_BASE
	},

	{ 
		FIFO_5_TO_0_OUT_BASE, 
		FIFO_5_TO_1_OUT_BASE, 
		FIFO_5_TO_2_OUT_BASE, 
		FIFO_5_TO_3_OUT_BASE,
		FIFO_5_TO_4_OUT_BASE,
		0,
		FIFO_5_TO_6_OUT_BASE,
		FIFO_5_TO_7_OUT_BASE
	},

	{ 
		FIFO_6_TO_0_OUT_BASE, 
		FIFO_6_TO_1_OUT_BASE, 
		FIFO_6_TO_2_OUT_BASE, 
		FIFO_6_TO_3_OUT_BASE,
		FIFO_6_TO_4_OUT_BASE,
		FIFO_6_TO_5_OUT_BASE,
		0,
		FIFO_6_TO_7_OUT_BASE
	},

	{ 
		FIFO_7_TO_0_OUT_BASE, 
		FIFO_7_TO_1_OUT_BASE, 
		FIFO_7_TO_2_OUT_BASE, 
		FIFO_7_TO_3_OUT_BASE,
		FIFO_7_TO_4_OUT_BASE,
		FIFO_7_TO_5_OUT_BASE,
		FIFO_7_TO_6_OUT_BASE,
		0
	}
};

alt_u32 fifoInDepths [][8] = {
	{ 
		0, 
		FIFO_0_TO_1_IN_FIFO_DEPTH, 
		FIFO_0_TO_2_IN_FIFO_DEPTH, 
		FIFO_0_TO_3_IN_FIFO_DEPTH,
		FIFO_0_TO_4_IN_FIFO_DEPTH,
		FIFO_0_TO_5_IN_FIFO_DEPTH,
		FIFO_0_TO_6_IN_FIFO_DEPTH, 
		FIFO_0_TO_7_IN_FIFO_DEPTH 
	},
	...
	{ 
		...
		FIFO_1_TO_3_IN_FIFO_DEPTH,
		FIFO_1_TO_4_IN_FIFO_DEPTH,
		FIFO_1_TO_5_IN_FIFO_DEPTH,
		FIFO_1_TO_6_IN_FIFO_DEPTH,
		FIFO_1_TO_7_IN_FIFO_DEPTH
	},
	...
	{ 
		...
		0, 
		FIFO_2_TO_3_IN_FIFO_DEPTH,
		FIFO_2_TO_4_IN_FIFO_DEPTH,
		FIFO_2_TO_5_IN_FIFO_DEPTH,
		FIFO_2_TO_6_IN_FIFO_DEPTH,
		FIFO_2_TO_7_IN_FIFO_DEPTH 
	},

	{ 
		FIFO_3_TO_0_IN_FIFO_DEPTH, 
		FIFO_3_TO_1_IN_FIFO_DEPTH, 
		FIFO_3_TO_2_IN_FIFO_DEPTH, 
		0,
		FIFO_3_TO_4_IN_FIFO_DEPTH,
		FIFO_3_TO_5_IN_FIFO_DEPTH,
		FIFO_3_TO_6_IN_FIFO_DEPTH,
		FIFO_3_TO_7_IN_FIFO_DEPTH  
	},

	{ 
		FIFO_4_TO_0_IN_FIFO_DEPTH, 
		FIFO_4_TO_1_IN_FIFO_DEPTH, 
		FIFO_4_TO_2_IN_FIFO_DEPTH, 
		FIFO_4_TO_3_IN_FIFO_DEPTH,
		0,
		FIFO_4_TO_5_IN_FIFO_DEPTH,
		FIFO_4_TO_6_IN_FIFO_DEPTH,
		FIFO_4_TO_7_IN_FIFO_DEPTH  
	},

	{ 
		FIFO_5_TO_0_IN_FIFO_DEPTH, 
		FIFO_5_TO_1_IN_FIFO_DEPTH, 
		FIFO_5_TO_2_IN_FIFO_DEPTH, 
		FIFO_5_TO_3_IN_FIFO_DEPTH,
		FIFO_5_TO_4_IN_FIFO_DEPTH,
		0,
		FIFO_5_TO_6_IN_FIFO_DEPTH,
		FIFO_5_TO_7_IN_FIFO_DEPTH
	},

	{ 
		FIFO_6_TO_0_IN_FIFO_DEPTH, 
		FIFO_6_TO_1_IN_FIFO_DEPTH, 
		FIFO_6_TO_2_IN_FIFO_DEPTH, 
		FIFO_6_TO_3_IN_FIFO_DEPTH,
		FIFO_6_TO_4_IN_FIFO_DEPTH,
		FIFO_6_TO_5_IN_FIFO_DEPTH,
		0,
		FIFO_6_TO_7_IN_FIFO_DEPTH
	},

	{ 
		FIFO_7_TO_0_IN_FIFO_DEPTH, 
		FIFO_7_TO_1_IN_FIFO_DEPTH, 
		FIFO_7_TO_2_IN_FIFO_DEPTH, 
		FIFO_7_TO_3_IN_FIFO_DEPTH,
		FIFO_7_TO_4_IN_FIFO_DEPTH,
		FIFO_7_TO_5_IN_FIFO_DEPTH,
		FIFO_7_TO_6_IN_FIFO_DEPTH,
		0
	}
};
...
alt_u32 fifoOutDepths [][8] = {
	{ 
		...
		FIFO_0_TO_3_OUT_FIFO_DEPTH,
		FIFO_0_TO_4_OUT_FIFO_DEPTH,
		FIFO_0_TO_5_OUT_FIFO_DEPTH,
		FIFO_0_TO_6_OUT_FIFO_DEPTH,
		FIFO_0_TO_7_OUT_FIFO_DEPTH  
	},
	...
	{ 
		...
		FIFO_1_TO_3_OUT_FIFO_DEPTH,
		FIFO_1_TO_4_OUT_FIFO_DEPTH,
		FIFO_1_TO_5_OUT_FIFO_DEPTH,
		FIFO_1_TO_6_OUT_FIFO_DEPTH,
		FIFO_1_TO_7_OUT_FIFO_DEPTH  
	},
	...
	{ 
		...
		0, 
		FIFO_2_TO_3_OUT_FIFO_DEPTH,
		FIFO_2_TO_4_OUT_FIFO_DEPTH,
		FIFO_2_TO_5_OUT_FIFO_DEPTH,
		FIFO_2_TO_6_OUT_FIFO_DEPTH,
		FIFO_2_TO_7_OUT_FIFO_DEPTH  
	},

	{ 
		FIFO_3_TO_0_OUT_FIFO_DEPTH, 
		FIFO_3_TO_1_OUT_FIFO_DEPTH, 
		FIFO_3_TO_2_OUT_FIFO_DEPTH, 
		0,
		FIFO_3_TO_4_OUT_FIFO_DEPTH,
		FIFO_3_TO_5_OUT_FIFO_DEPTH,
		FIFO_3_TO_6_OUT_FIFO_DEPTH,
		FIFO_3_TO_7_OUT_FIFO_DEPTH 
	},

	{ 
		FIFO_4_TO_0_OUT_FIFO_DEPTH, 
		FIFO_4_TO_1_OUT_FIFO_DEPTH, 
		FIFO_4_TO_2_OUT_FIFO_DEPTH, 
		FIFO_4_TO_3_OUT_FIFO_DEPTH,
		0,
		FIFO_4_TO_5_OUT_FIFO_DEPTH,
		FIFO_4_TO_6_OUT_FIFO_DEPTH,
		FIFO_4_TO_7_OUT_FIFO_DEPTH
	},

	{ 
		FIFO_5_TO_0_OUT_FIFO_DEPTH, 
		FIFO_5_TO_1_OUT_FIFO_DEPTH, 
		FIFO_5_TO_2_OUT_FIFO_DEPTH, 
		FIFO_5_TO_3_OUT_FIFO_DEPTH,
		FIFO_5_TO_4_OUT_FIFO_DEPTH,
		0,
		FIFO_5_TO_6_OUT_FIFO_DEPTH,
		FIFO_5_TO_7_OUT_FIFO_DEPTH
	},

	{ 
		FIFO_6_TO_0_OUT_FIFO_DEPTH, 
		FIFO_6_TO_1_OUT_FIFO_DEPTH, 
		FIFO_6_TO_2_OUT_FIFO_DEPTH, 
		FIFO_6_TO_3_OUT_FIFO_DEPTH,
		FIFO_6_TO_4_OUT_FIFO_DEPTH,
		FIFO_6_TO_5_OUT_FIFO_DEPTH,
		0,
		FIFO_6_TO_7_OUT_FIFO_DEPTH
	},

	{ 
		FIFO_7_TO_0_OUT_FIFO_DEPTH, 
		FIFO_7_TO_1_OUT_FIFO_DEPTH, 
		FIFO_7_TO_2_OUT_FIFO_DEPTH, 
		FIFO_7_TO_3_OUT_FIFO_DEPTH,
		FIFO_7_TO_4_OUT_FIFO_DEPTH,
		FIFO_7_TO_5_OUT_FIFO_DEPTH,
		FIFO_7_TO_6_OUT_FIFO_DEPTH,
		0
	}
};
