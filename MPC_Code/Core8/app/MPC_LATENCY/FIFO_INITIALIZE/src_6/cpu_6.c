...
/****************/
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		MPC_initialize_fifos(6,ALMOST_FULL,1);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		MPC_initialize_fifos(6,12,ALMOST_EMPTY);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		MPC_initialize_fifos(6,ALMOST_FULL,ALMOST_EMPTY);
	...
	MPC_send_to_CPU(CPU_6, CPU_7 , 10);
