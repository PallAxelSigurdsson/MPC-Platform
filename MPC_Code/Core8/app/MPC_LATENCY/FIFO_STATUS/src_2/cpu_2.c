	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		for(SENDER = 0; SENDER < CORE_COUNT; SENDER++){
			...
			for(INDEX = 0; INDEX < 13; INDEX++){
				...
				DATA = MPC_FIFO_status(SENDER, 2, 0x3F);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		for(SENDER = 0; SENDER < CORE_COUNT; SENDER++){
			...
			for(INDEX = 0; INDEX < 13; INDEX++){
				...
				DATA = MPC_FIFO_status(SENDER, 2, MASK);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		for(RECEIVER = 0; RECEIVER < CORE_COUNT; RECEIVER++){
			...
			for(INDEX = 0; INDEX < 13; INDEX++){
				...
				DATA = MPC_FIFO_status(2, RECEIVER, 0x3F);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		for(RECEIVER = 0; RECEIVER < CORE_COUNT; RECEIVER++){
			...
			for(INDEX = 0; INDEX < 13; INDEX++){
				...
				DATA = MPC_FIFO_status(2, RECEIVER, MASK);
