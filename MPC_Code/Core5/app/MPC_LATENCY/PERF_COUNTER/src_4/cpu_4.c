...
int main()
{
	...
	for(COUNTER8 = 1; COUNTER8 < 8; COUNTER8++){
		...
		for(ITERATION = 0; ITERATION < 10000; ITERATION++){
			...
			PERF_START_MEASURING(PERFORMANCE_COUNTER_4_BASE);	
			PERF_BEGIN(PERFORMANCE_COUNTER_4_BASE,COUNTER8);

			//Nothing - Measuring overhead of Performance Counter

			PERF_END(PERFORMANCE_COUNTER_4_BASE,COUNTER8);	
			PERF_STOP_MEASURING(PERFORMANCE_COUNTER_4_BASE);

			TIMER = perf_get_section_time(PERFORMANCE_COUNTER_4_BASE, COUNTER8);
	...
	for(COUNTER16 = 1; COUNTER16 < 8; COUNTER16++){
		...
		for(ITERATION = 0; ITERATION < 10000; ITERATION++){
			...
			PERF_START_MEASURING(PERFORMANCE_COUNTER_4_BASE);	
			PERF_BEGIN(PERFORMANCE_COUNTER_4_BASE,COUNTER16);

			//Nothing - Measuring overhead of Performance Counter

			PERF_END(PERFORMANCE_COUNTER_4_BASE,COUNTER16);	
			PERF_STOP_MEASURING(PERFORMANCE_COUNTER_4_BASE);

			TIMER = perf_get_section_time(PERFORMANCE_COUNTER_4_BASE, COUNTER16);
	...
	for(COUNTER32 = 1; COUNTER32 < 8; COUNTER32++){
		...
		for(ITERATION = 0; ITERATION < 10000; ITERATION++){
			...
			PERF_START_MEASURING(PERFORMANCE_COUNTER_4_BASE);	
			PERF_BEGIN(PERFORMANCE_COUNTER_4_BASE,COUNTER32);

			//Nothing - Measuring overhead of Performance Counter

			PERF_END(PERFORMANCE_COUNTER_4_BASE,COUNTER32);	
			PERF_STOP_MEASURING(PERFORMANCE_COUNTER_4_BASE);

			TIMER = perf_get_section_time(PERFORMANCE_COUNTER_4_BASE, COUNTER32);
	...
	for(COUNTER_INT = 1; COUNTER_INT < 8; COUNTER_INT++){
		...
		for(ITERATION = 0; ITERATION < 10000; ITERATION++){
			...
			PERF_START_MEASURING(PERFORMANCE_COUNTER_4_BASE);	
			PERF_BEGIN(PERFORMANCE_COUNTER_4_BASE,COUNTER_INT);

			//Nothing - Measuring overhead of Performance Counter

			PERF_END(PERFORMANCE_COUNTER_4_BASE,COUNTER_INT);	
			PERF_STOP_MEASURING(PERFORMANCE_COUNTER_4_BASE);

			TIMER = perf_get_section_time(PERFORMANCE_COUNTER_4_BASE, COUNTER_INT);
