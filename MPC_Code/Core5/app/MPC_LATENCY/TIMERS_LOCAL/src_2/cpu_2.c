...
printf("\nLocal System Timer Period - alt_u32 CPU_ID - alt_u32 Period\n\n");
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		READ_DATA = MPC_local_timestamp(2);
