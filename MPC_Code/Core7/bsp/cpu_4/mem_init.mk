...
# Memory: onchip_memory_4
MEM_0 := Core8_onchip_memory_4
$(MEM_0)_NAME := onchip_memory_4
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory_4
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory_4
onchip_memory_4: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_shared
MEM_1 := Core8_onchip_shared
$(MEM_1)_NAME := onchip_shared
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_shared
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_shared
onchip_shared: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
