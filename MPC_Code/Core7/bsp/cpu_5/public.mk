...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../hardware/Core7.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../hardware/Core7.sopcinfo
...
# setting hal.stderr is jtag_uart_5
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_5

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_5
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_5
...
# setting hal.stdout is jtag_uart_5
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_5
