...
int main()
{
	...
	MPC_initialize_fifos(CPU_2, 12, 1);
	MPC_receive_from_CPU(CPU_1, CPU_2);
...
/****************/
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		MPC_initialize_fifos(2,ALMOST_FULL,1);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		MPC_initialize_fifos(2,12,ALMOST_EMPTY);
	...
	for(INDEX = 0; INDEX < ITERATIONS; INDEX++){
		...
		MPC_initialize_fifos(2,ALMOST_FULL,ALMOST_EMPTY);
	...
	MPC_send_to_CPU(CPU_2, CPU_3 , 10);
